...
# Load the CSV file
df = pd.read_csv('C:\\Users\\prade\\OneDrive\\Desktop\\SupplyChain\\PlantPorts.csv', dtype=object)
...
PlantPorts_df = pd.DataFrame(df[["PlantCode","Port"]])
...
PlantPorts_df.to_sql('PlantPorts', engine, if_exists='append', index=False)